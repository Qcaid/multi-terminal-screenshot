...
const url = ref("blog.vegecai.moe");
const phone = ref("");
const pad = ref("");
const computer = ref("");
const laptop = ref("");
  ...
  <section class="main">
    ...
    <transition name="fade">
      <div v-if="coverShow" class="cover">
        <div class="close-preview" @click="resetPreview">
    ...
    <div class="preview-box">
      <div
        class="computer"
        :class="{
          active: activeDevice === Device.computer,
          activated: activeDevice,
        }"
      ...
      <div
        class="laptop"
        :class="{
          active: activeDevice === Device.laptop,
          activated: activeDevice,
        }"
      ...
      <div
        class="phone"
        :class="{
          active: activeDevice === Device.phone,
          activated: activeDevice,
        }"
      ...
      <div
        class="pad"
        :class="{
          active: activeDevice === Device.pad,
          activated: activeDevice,
        }"
    ...
    <transition name="fade">
      <div class="controls" v-if="!activeDevice">
        ...
        <div class="url">
          <div class="default">
            <span
              @click.stop="customURL = !customURL"
              class="website"
              :class="{ active: customURL }"
            >
          ...
          <transition name="fade">
            <div class="custom" v-if="customURL">
              <div class="laptop">
                <span><i class="iconfont icon-wangye"></i> 笔记本</span
                ><span>{{ protocol }}://</span
                ><input
                  type="text"
                  placeholder="请输入网址"
              ...
              <div class="phone">
                <span><i class="iconfont icon-shumashouji"></i> 手机</span
                ><span>{{ protocol }}://</span
                ><input
                  type="text"
                  placeholder="请输入网址"
              ...
              <div class="pad">
                <span><i class="iconfont icon-pingban"></i> 平板</span
                ><span>{{ protocol }}://</span
                ><input
                  type="text"
                  placeholder="请输入网址"
              ...
              <div class="computer">
                <span><i class="iconfont icon-diannao"></i> 电脑</span
                ><span>{{ protocol }}://</span
                ><input
                  type="text"
                  placeholder="请输入网址"
                  v-model.trim="computer"
                  class="url"
                />
              </div>
              <div class="close" @click="customURL = false">
                <i class="iconfont icon-cancel-1-copy"></i>
              </div>
            </div>
          </transition>
        ...
        <div class="scroll-bar">
          <label>
            <div class="checkbox">
              <i
                class="iconfont"
                :class="scrollBar ? 'icon-yigouxuan' : 'icon-weigouxuan'"
              ></i>
            </div>
...
.main {
  ...
  .preview-box {
    ...
    .computer {
      ...
      width: 610px;
      height: 572px;
      background: url(./assets/images/new-model/computer.png) no-repeat 0 0 /
        contain;
    ...
    .laptop {
      ...
      width: 600px;
      height: 380px;
      background: url(./assets/images/new-model/laptop.png) no-repeat 0 0 /
        contain;
      transform: scale(0.9);
    ...
    .phone {
      ...
      width: 168px;
      height: 350px;
      background: url(./assets/images/new-model/mobile.png) no-repeat 0 0 /
        contain;
      transform: scale(0.8);
    ...
    .pad {
      ...
      width: 300px;
      height: 400px;
      background: url(./assets/images/new-model/tablet.png) no-repeat 0 0 /
        contain;
